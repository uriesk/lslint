...
"const integer PAYMENT_INFO_ON_FILE = 1",
"const integer PAYMENT_INFO_USED = 2",
...
"const integer PRIM_MEDIA_PERM_NONE = 0",
...
"const integer REGION_FLAG_ALLOW_DAMAGE = 1",
...
"const integer STRING_TRIM = 3",
"const integer STRING_TRIM_HEAD = 1",
"const integer STRING_TRIM_TAIL = 2",
