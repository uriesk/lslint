...
"string osGetInventoryDesc( string item )",
...
"void osSetSpeed( key UUID, float SpeedModifier )",
...
"const integer AGENT_MALE = 0x2000",
...
"const integer CAMERA_FOCUS_OFFSET_X = 2",
"const integer CAMERA_FOCUS_OFFSET_Y = 3",
"const integer CAMERA_FOCUS_OFFSET_Z = 4",
"const integer CAMERA_FOCUS_THRESHOLD = 11",
"const integer CAMERA_FOCUS_X = 18",
"const integer CAMERA_FOCUS_Y = 19",
"const integer CAMERA_FOCUS_Z = 20",
...
"const integer CAMERA_POSITION_X = 14",
"const integer CAMERA_POSITION_Y = 15",
"const integer CAMERA_POSITION_Z = 16",
"const integer CHANGED_ALLOWED_DROP = 0x40",
"const integer CHANGED_ANIMATION = 0x4000",
...
"const integer CHANGED_POSITION = 0x8000",
"const integer CHANGED_REGION = 0x100",
"const integer CHANGED_REGION_RESTART = 0x400",
...
"const integer DATA_SIM_RELEASE = 128",
...
"const integer LIST_STAT_HARMONIC_MEAN = 100",
...
"const integer LSL_STATUS_BOUNDS_ERROR = 1002",
"const integer LSL_STATUS_INTERNAL_ERROR = 1999",
"const integer LSL_STATUS_MALFORMED_PARAMS = 1000",
"const integer LSL_STATUS_NOT_FOUND = 1003",
"const integer LSL_STATUS_NOT_SUPPORTED = 1004",
"const integer LSL_STATUS_OK = 0",
"const integer LSL_STATUS_TYPE_MISMATCH = 1001",
"const integer LSL_STATUS_WHITELIST_FAILED = 2001",
...
"const integer OS_ATTACH_MSG_ALL = -65535",
"const integer OS_ATTACH_MSG_INVERT_POINTS = 1",
"const integer OS_ATTACH_MSG_OBJECT_CREATOR = 2",
"const integer OS_ATTACH_MSG_SCRIPT_CREATOR = 4",
"const integer OS_LISTEN_REGEX_MESSAGE = 0x2",
"const integer OS_LISTEN_REGEX_NAME = 0x1",
"const integer OS_NPC_CREATOR_OWNED = 0x1",
"const integer OS_NPC_FLY = 0",
"const integer OS_NPC_LAND_AT_TARGET = 2",
"const integer OS_NPC_NOT_OWNED = 0x2",
"const integer OS_NPC_NO_FLY = 1",
"const integer OS_NPC_OBJECT_GROUP = 0x8",
"const integer OS_NPC_RUNNING = 4",
"const integer OS_NPC_SENSE_AS_AGENT = 0x4",
"const integer OS_NPC_SIT_NOW = 0",
...
"const integer PARCEL_DETAILS_CLAIMDATE = 10",
...
"const integer STATS_ACTIVE_PRIMS = 7",
"const integer STATS_ACTIVE_SCRIPTS = 19",
"const integer STATS_AGENT_MS = 16",
"const integer STATS_AGENT_UPDATES = 3",
"const integer STATS_CHILD_AGENTS = 5",
"const integer STATS_FRAME_MS = 8",
"const integer STATS_IMAGE_MS = 11",
"const integer STATS_IN_PACKETS_PER_SECOND = 13",
"const integer STATS_NET_MS = 9",
"const integer STATS_OTHER_MS = 12",
"const integer STATS_OUT_PACKETS_PER_SECOND = 14",
"const integer STATS_PENDING_DOWNLOADS = 17",
"const integer STATS_PENDING_UPLOADS = 18",
"const integer STATS_PHYSICS_FPS = 2",
"const integer STATS_PHYSICS_MS = 10",
"const integer STATS_ROOT_AGENTS = 4",
"const integer STATS_SCRIPT_LPS = 20",
"const integer STATS_SIM_FPS = 1",
"const integer STATS_TIME_DILATION = 0",
"const integer STATS_TOTAL_PRIMS = 6",
"const integer STATS_UNACKED_BYTES = 15",
...
"const integer VEHICLE_FLAG_LOCK_HOVER_HEIGHT = 0x2000",
"const integer VEHICLE_FLAG_LOCK_ROTATION = 0x8010",
"const integer VEHICLE_FLAG_MOUSELOOK_BANK = 0x100",
"const integer VEHICLE_FLAG_MOUSELOOK_STEER = 0x80",
"const integer VEHICLE_FLAG_NO_DEFLECTION = 0x4008",
"const integer VEHICLE_FLAG_NO_DEFLECTION_UP = 0x1",
"const integer VEHICLE_FLAG_NO_X = 0x400",
"const integer VEHICLE_FLAG_NO_Y = 0x800",
"const integer VEHICLE_FLAG_NO_Z = 0x1000",
...
"const integer VEHICLE_RANGE_BLOCK = 45",
"const integer VEHICLE_REFERENCE_FRAME = 44",
"const integer VEHICLE_ROLL_FRAME = 46",
...
"const integer WL_AMBIENT = 20",
"const integer WL_BIG_WAVE_DIRECTION = 9",
"const integer WL_BLUE_DENSITY = 14",
"const integer WL_BLUR_MULTIPLIER = 8",
"const integer WL_CLOUD_COLOR = 26",
"const integer WL_CLOUD_COVERAGE = 28",
"const integer WL_CLOUD_DETAIL_XY_DENSITY = 30",
"const integer WL_CLOUD_SCALE = 29",
"const integer WL_CLOUD_SCROLL_X = 31",
"const integer WL_CLOUD_SCROLL_X_LOCK = 34",
"const integer WL_CLOUD_SCROLL_Y = 32",
"const integer WL_CLOUD_SCROLL_Y_LOCK = 33",
"const integer WL_CLOUD_XY_DENSITY = 27",
"const integer WL_DENSITY_MULTIPLIER = 16",
"const integer WL_DISTANCE_MULTIPLIER = 17",
"const integer WL_DRAW_CLASSIC_CLOUDS = 35",
"const integer WL_EAST_ANGLE = 21",
"const integer WL_FRESNEL_OFFSET = 5",
"const integer WL_FRESNEL_SCALE = 4",
"const integer WL_HAZE_DENSITY = 15",
"const integer WL_HAZE_HORIZON = 13",
"const integer WL_HORIZON = 12",
"const integer WL_LITTLE_WAVE_DIRECTION = 10",
"const integer WL_MAX_ALTITUDE = 18",
"const integer WL_NORMAL_MAP_TEXTURE = 11",
"const integer WL_REFLECTION_WAVELET_SCALE = 3",
"const integer WL_REFRACT_SCALE_ABOVE = 6",
"const integer WL_REFRACT_SCALE_BELOW = 7",
"const integer WL_SCENE_GAMMA = 24",
"const integer WL_STAR_BRIGHTNESS = 25",
"const integer WL_SUN_GLOW_FOCUS = 22",
"const integer WL_SUN_GLOW_SIZE = 23",
"const integer WL_SUN_MOON_COLOR = 19",
"const integer WL_SUN_MOON_POSITION = 36",
"const integer WL_UNDERWATER_FOG_MODIFIER = 2",
"const integer WL_WATER_COLOR = 0",
"const integer WL_WATER_FOG_DENSITY_EXPONENT = 1",
